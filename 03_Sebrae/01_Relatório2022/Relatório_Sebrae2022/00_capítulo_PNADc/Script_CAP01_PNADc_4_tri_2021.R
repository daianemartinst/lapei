...
pnadc_goias21_4tri <- subset(dados_pnadc21_4tri, UF == "Goi谩s")
pnadc_goias21_4tri
...
totalsexo_empregado21_4tri <- svytotal(~V2007, subset(pnadc_goias21_4tri, VD4007 == "Empregado (inclusive trabalhador dom茅stico)"), na.rm = T)
...
totalsexo_cpropria21_4tri <- svytotal(~V2007, subset(pnadc_goias21_4tri, VD4007 == "Conta pr贸pria"), na.rm = T)
totalsexo_cpropria21_4tri  # (total por conta propria)

total_trabalhador <- svytotal(~VD4007, pnadc_goias21_4tri, na.rm = T)
total_trabalhador

proporcao_totalsexo_empregado21_4tri <- svymean(~V2007, subset(pnadc_goias21_4tri, VD4007 == "Empregado (inclusive trabalhador dom茅stico)"), na.rm = T)
...
#---------Mulher----------
mediarenda_M_empregado21_4tri <- svymean(~VD4017, subset(pnadc_mulherGO21_4tri, VD4007 == "Empregado (inclusive trabalhador dom茅stico)"), na.rm = T)
...
mediarenda_M_cpropria21_4tri <- svymean(~VD4017, subset(pnadc_mulherGO21_4tri, VD4007 == "Conta pr贸pria"), na.rm = T)
mediarenda_M_cpropria21_4tri

#--------Homem-----------

mediarenda_H_empregado21_4tri <- svymean(~VD4017, subset(pnadc_homemGO21_4tri, VD4007 == "Empregado (inclusive trabalhador dom茅stico)"), na.rm = T)
...
mediarenda_H_cpropria21_4tri <- svymean(~VD4017, subset(pnadc_homemGO21_4tri, VD4007 == "Conta pr贸pria"), na.rm = T)
...
#medianarenda_M_empregado21_4tri <- svyquantile(~VD4017, subset(pnadc_mulherGO21_4tri, VD4007 == "Empregado (inclusive trabalhador dom茅stico)"), quantiles = .5, na.rm = T)
...
#medianarenda_M_cpropria21_4tri <- svyquantile(~VD4017, subset(pnadc_mulherGO21_4tri, VD4007 == "Conta pr贸pria"), quantiles = .5, na.rm = T)
#medianarenda_M_cpropria21_4tri 

#--------Homem------------

#medianarenda_H_empregado21_4tri <- svyquantile(~VD4017, subset(pnadc_homemGO21_4tri, VD4007 == "Empregado (inclusive trabalhador dom茅stico)"), quantiles = .5, na.rm = T)
...
#medianarenda_H_cpropria21_4tri <- svyquantile(~VD4017, subset(pnadc_homemGO21_4tri, VD4007 == "Conta pr贸pria"), quantiles = .5, na.rm = T)
#medianarenda_H_cpropria21_4tri

#---------------------------------------------------------------

# Total de trabalhadores - Ra莽a (divisao por sexo)----
...
idade_M_empregado21_4tri <- svymean(~V2009, subset(pnadc_mulherGO21_4tri, VD4007 == "Empregado (inclusive trabalhador dom茅stico)"), na.rm = T)
...
idade_M_cpropria21_4tri <- svymean(~V2009, subset(pnadc_mulherGO21_4tri, VD4007 == "Conta pr贸pria"), na.rm = T)
idade_M_cpropria21_4tri

#----------Homem---------

idade_H_empregado21_4tri <- svymean(~V2009, subset(pnadc_homemGO21_4tri, VD4007 == "Empregado (inclusive trabalhador dom茅stico)"), na.rm = T)
...
idade_H_cpropria21_4tri <- svymean(~V2009, subset(pnadc_homemGO21_4tri, VD4007 == "Conta pr贸pria"), na.rm = T)
...
#medianaidade_H_empregado21_4tri <- svyquantile(~V2009, subset(pnadc_homemGO21_4tri, VD4007 == "Empregado (inclusive trabalhador dom茅stico)"), quantiles = .5, na.rm = T)
...
#medianaidade_H_cpropria21_4tri <- svyquantile(~V2009, subset(pnadc_homemGO21_4tri, VD4007 == "Conta pr贸pria"), quantiles = .5, na.rm = T)
...
horasT_M_empregado21_4tri <- svytotal(~VD4036, subset (pnadc_mulherGO21_4tri, VD4007 == "Empregado (inclusive trabalhador dom茅stico)"), na.rm = T)
...
horasT_M_cpropria21_4tri <- svytotal(~VD4036, subset (pnadc_mulherGO21_4tri, VD4007 == "Conta pr贸pria"), na.rm = T)
horasT_M_cpropria21_4tri

#-------Homem--------

horasT_H_empregado21_4tri <- svytotal(~VD4036, subset (pnadc_homemGO21_4tri, VD4007 == "Empregado (inclusive trabalhador dom茅stico)"), na.rm = T)
...
horasT_H_cpropria21_4tri <- svytotal(~VD4036, subset (pnadc_homemGO21_4tri, VD4007 == "Conta pr贸pria"), na.rm = T)
...
horasEfetivamenteT_M_empregado21_4tri <- svytotal(~VD4032, subset (pnadc_mulherGO21_4tri, VD4007 == "Empregado (inclusive trabalhador dom茅stico)"), na.rm = T)
...
horasEfetivamenteT_M_cpropria21_4tri <- svytotal(~VD4032, subset (pnadc_mulherGO21_4tri, VD4007 == "Conta pr贸pria"), na.rm = T)
horasEfetivamenteT_M_cpropria21_4tri

#-------Homem--------

horasEfetivamenteT_H_empregado21_4tri <- svytotal(~VD4032, subset (pnadc_homemGO21_4tri, VD4007 == "Empregado (inclusive trabalhador dom茅stico)"), na.rm = T)
...
horasEfetivamenteT_H_cpropria21_4tri <- svytotal(~VD4032, subset (pnadc_homemGO21_4tri, VD4007 == "Conta pr贸pria"), na.rm = T)
...
horasHabitualmenteT_M_empregado21_4tri <- svymean(~VD4031, subset (pnadc_mulherGO21_4tri, VD4007 == "Empregado (inclusive trabalhador dom茅stico)"), na.rm = T)
...
horasHabitualmenteT_M_cpropria21_4tri <- svymean(~VD4031, subset (pnadc_mulherGO21_4tri, VD4007 == "Conta pr贸pria"), na.rm = T)
horasHabitualmenteT_M_cpropria21_4tri

#-------Homem--------

horasHabitualmenteT_H_empregado21_4tri <- svymean(~VD4031, subset (pnadc_homemGO21_4tri, VD4007 == "Empregado (inclusive trabalhador dom茅stico)"), na.rm = T)
...
horasHabitualmenteT_H_cpropria21_4tri <- svymean(~VD4031, subset (pnadc_homemGO21_4tri, VD4007 == "Conta pr贸pria"), na.rm = T)
...
local_trabalho_empregado_mulher21_4tri <- svytotal(~V4022, subset (pnadc_mulherGO21_4tri, VD4007 == "Empregado (inclusive trabalhador dom閟tico)"), na.rm = T)
...
local_trabalho_cpropria_mulher21_4tri <- svytotal(~V4022, subset (pnadc_mulherGO21_4tri, VD4007 == "Conta pr髉ria"), na.rm = T)
local_trabalho_cpropria_mulher21_4tri

#-------Homem--------

localtrabalho_empregado_homem21_4tri <- svytotal(~V4022, subset (pnadc_homemGO21_4tri, VD4007 == "Empregado (inclusive trabalhador dom閟tico)"), na.rm = T)
...
localtrabalho_cpropria_homem21_4tri <- svytotal(~V4022, subset (pnadc_homemGO21_4tri, VD4007 == "Conta pr髉ria"), na.rm = T)
localtrabalho_cpropria_homem21_4tri


####### Esse neg骳io era registrado no CNPJ######
...
CNPJ_cpropria_mulher21_4tri <- svytotal(~V4019, subset (pnadc_mulherGO21_4tri, VD4007 == "Conta pr髉ria"), na.rm = T)
...
CNPJ_cpropria_homem21_4tri <- svytotal(~V4019, subset (pnadc_homemGO21_4tri, VD4007 == "Conta pr髉ria"), na.rm = T)
CNPJ_cpropria_homem21_4tri


###### C骴igo da principal atividade desse neg骳io/empresa#######
...
####### Quantos empregados trabalhavam nesse neg骳io##########
...
qtdEMPREGADOS_cpropria_mulher21_4tri <- svytotal(~V4016, subset (pnadc_mulherGO21_4tri, VD4007 == "Conta pr髉ria"), na.rm = T)
...
qtdEMPREGADOS_cpropria_homem21_4tri <- svytotal(~V4016, subset (pnadc_homemGO21_4tri, VD4007 == "Conta pr髉ria"), na.rm = T)
qtdEMPREGADOS_cpropria_homem21_4tri


##### tinha pelo menos um s骳io que trabalhava nesse neg骳io/empresa#####
...
socio_cpropria_mulher21_4tri <- svytotal(~V4017, subset (pnadc_mulherGO21_4tri, VD4007 == "Conta pr髉ria"), na.rm = T)
...
socio_cpropria_homem21_4tri <- svytotal(~V4017, subset (pnadc_homemGO21_4tri, VD4007 == "Conta pr髉ria"), na.rm = T)
...
qtdsocio_cpropria_mulher21_4tri <- svytotal(~V40171, subset (pnadc_mulherGO21_4tri, VD4007 == "Conta pr髉ria"), na.rm = T)
...
qtdsocio_cpropria_homem21_4tri <- svytotal(~V40171, subset (pnadc_homemGO21_4tri, VD4007 == "Conta pr髉ria"), na.rm = T)
...
tempotrabalho_cpropria_mulher21_4tri <- svytotal(~V4040, subset (pnadc_mulherGO21_4tri, VD4007 == "Conta pr髉ria"), na.rm = T)
...
tempotrabalho_cpropria_homem21_4tri <- svytotal(~V4040, subset (pnadc_homemGO21_4tri, VD4007 == "Conta pr髉ria"), na.rm = T)
tempotrabalho_cpropria_homem21_4tri


####  Qual foi a principal provid阯cia que ... tomou para conseguir trabalho#####
...
PROVtrabalho_cpropria_mulher21_4tri <- svytotal(~V4072, subset (pnadc_mulherGO21_4tri, VD4007 == "Conta pr髉ria"), na.rm = T)
...
PROVtrabalho_cpropria_mulher21_4tri <- svytotal(~V4072, subset (pnadc_homemGO21_4tri, VD4007 == "Conta pr髉ria"), na.rm = T)
PROVtrabalho_cpropria_mulher21_4tri
