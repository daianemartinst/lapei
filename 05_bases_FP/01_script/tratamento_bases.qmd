...
bandalarga_Meu_Municipio_Acessos <- read_delim("00_bases/bandalarga_Meu_Municipio_Acessos.csv", delim = ";", escape_double = FALSE, trim_ws = TRUE)

Banda_larga_municipio_2022 <- bandalarga_Meu_Municipio_Acessos %>% 
                              select(Serviço, Densidade, `Código IBGE`) %>% 
                              mutate(`Código IBGE` = as.character(`Código IBGE`)) %>% 
                              spread(Serviço, Densidade)
