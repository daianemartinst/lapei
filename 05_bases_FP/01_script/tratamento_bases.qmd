...
Conforme Silva e Bastos (2022), algumas variáveis de natureza ambiental contribuem para explicar o fenômeno empreendedores, a exemplo dos contextos econômico e social nos quais os indivíduos estão inseridos.
Tendo em vista do contexto, pesquisadores testaram o efeito de outras variáveis - como, violência (Shahriar & Shepherd, 2019), educação (Lofstrom, Bates & Parker, 2014), infraestrutura (Woolley, 2014), gênero (Zwan, Verheul & Thurik, 2012), leis e ambiente econômico (Coomes, Fernandez & Ghomann, 2013) sobre a emergência de empresas.
