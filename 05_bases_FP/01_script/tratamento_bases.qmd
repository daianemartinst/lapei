...
<p style='text-align:justify'>Os dados de homicídio foram extraídos do Atlas da Violência do IPEA.
...
4)  retiramos o dígito verificador do código IBGE, pois algumas bases não utilizam o 7º dígito </p>
...
```
Você pode baixar o dado tratado clicando [**aqui**](https://github.com/danielppagotto/lapei/blob/main/05_bases_FP/01_script/00_bases/homicidios.csv)


### 2) SEBRAE

<p style='text-align:justify'> Aqui estamos tratando a base do SEBRAE, pois ela não possui um código de identificação de município (ex.: código IBGE).

Os dados de unidades do SEBRAE foram acessados [**aqui**](https://transparencia.sebrae.com.br/infraestrutura?unidade=)</p>
...
```
Você pode baixar o dado tratado clicando [**aqui**](https://github.com/danielppagotto/lapei/blob/main/05_bases_FP/01_script/00_bases/sebrae.xlsx)


### 3) Munic

<p style='text-align:justify'> A MUNIC é uma base do IBGE que traz informações sobre características dos 5570 municípios.
...
Você pode baixar o dado tratado clicando [**aqui**](https://github.com/danielppagotto/lapei/blob/main/05_bases_FP/01_script/00_bases/Munic.xlsx)
...
<figure>
 ...
 <figcaption style='text-align:center'> Adaleny Paiva,Título: Bacharela(Mestranda - PPGS/UFG),E-mail: adalenypaiva@discente.ufg.br</figcaption>
  
</figure>

<figure>
  <img src="imagens/Henrique_Administração.jpeg" 
    width="200" 
    height="200"
    align="left">

 <figcaption style='text-align:center'> Henrique Silveira,Título: Graduando(FACE/UFG),E-mail: henriqueribeiro@discente.ufg.br</figcaption>
  
</figure>

<figure>
  <img src="imagens/Daniel_Pagotto.jpg" 
    width="200" 
    height="200"
    align="left">

 <figcaption style='text-align:center'> Daniel Pagotto,Título: Mestre (Doutorando PPGA/UnB),E-mail:
danielppagotto@ufg.br</figcaption>
