...
export(auxilio_br, "auxilio_brasil_tratada.csv")
...
O [Produto Interno Bruto dos Municípios](https://www.ibge.gov.br/estatisticas/economicas/contas-nacionais/9088-produto-interno-bruto-dos-municipios.html?=&t=downloads)
...
export(pib_munic, "pib_munic_tratado.csv")
...
[GEOSES](https://legado.dados.gov.br/dataset/geoses)
...
export(geoses_reduzida, "geoses_reduzida_tratada.csv")
...
[População Residente](http://tabnet.datasus.gov.br/cgi/deftohtm.exe?ibge/cnv/popsvsbr.def)
...
Paiva, A.D.S; Silveira, H.; Pagotto, D. P. Bases para pesquisas em ciências sociais. Laboratório de Pesquisa em Empreendedorismo e Inovação - Universidade Federal de Goiás.
