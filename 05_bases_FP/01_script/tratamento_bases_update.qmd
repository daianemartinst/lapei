...
Munic_TIC <- read_excel("00_bases/Munic.xlsx", sheet = "Comunicção e informática") %>% 
                  ...
                  rename(Possui_computador = MTIC02,
                         ...
                         Boletos = MTIC166,
                         Não_disponibilizou = MTIC167,
                         Bilhete_eletrônico = MTIC261,
                         Ônibus_GPS = MTIC262,
                         Centro_controle = MTIC263,
                         Iluminação_inteligente = MTIC264,
                         Semáforos_inteligentes = MTIC265,
                         Sensores_monitoria = MTIC266)
...
Indice_segur_hidrica_10_2022 <- indice_seguranca_hidrica_out_2022 %>% 
